...
\index{User@{User}!make\+Gold@{make\+Gold}}
\index{make\+Gold@{make\+Gold}!User@{User}}
\subsubsection{\texorpdfstring{make\+Gold()}{makeGold()}}
...
\index{User@{User}!stop\+Gold@{stop\+Gold}}
\index{stop\+Gold@{stop\+Gold}!User@{User}}
